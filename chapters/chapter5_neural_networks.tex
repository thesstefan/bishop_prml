...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= \bigg(\sum_{k}^{} \pi_k \mathcal{N}(w_i | \mu_k, \sigma_k^2)\bigg)^{-1}
            \sum_{i}^{} \pi_j \pdv{\mu_j} \mathcal{N}(w_i | \mu_j, \sigma_j^2) \\
        &= \bigg(\sum_{k}^{} \pi_k \mathcal{N}(w_i | \mu_k, \sigma_k^2)\bigg)^{-1}
            \sum_{j}^{} \pi_j \frac{\mu_j - w_i}{\sigma_j^2} \mathcal{N}(w_i | \mu_j, \sigma_j^2) \\
...
\vspace{1em}
    ...
    \begin{align*}
        ...
        &= \bigg(\sum_{k}^{} \pi_k \mathcal{N}(w_i | \mu_k, \sigma_k^2)\bigg)^{-1}
            \sum_{i}^{} \pi_j \pdv{\sigma_j} \mathcal{N}(w_i | \mu_j, \sigma_j^2) \\
        &= \bigg(\sum_{k}^{} \pi_k \mathcal{N}(w_i | \mu_k, \sigma_k^2)\bigg)^{-1}
            \sum_{i}^{} \pi_j \bigg(\frac{1}{\sigma_j} - \frac{(w_i - \mu_j)^2}{\sigma_j^3}\bigg) 
            \mathcal{N}(w_i | \mu_j, \sigma_j^2) \\
        &= \sum_{i}^{} \frac{\pi_j \mathcal{N}(w_i | \mu_j, \sigma_j^2)} 

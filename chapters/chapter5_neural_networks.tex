...
\begin{proof}
    ...
    \] 
    which is analogous to $(5.84)$ for the multiple output case.
\end{proof}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        = \nabla_\mathbf{w} \sum_{n=1}^{N} \pdv{E}{a_n} \pdv{a_n}{\mathbf{w}}
        = \nabla_\mathbf{w} \sum_{n=1}^{N} \pdv{E}{a_n} \nabla_\mathbf{w} a_n
        = \nabla_\mathbf{w} \sum_{n=1}^{N} \pdv{E}{a_n} \nabla_\mathbf{w} a_n
    \end{align*}
    ...
    \begin{align*}
        \mathbf{H} 
        = \nabla_\mathbf{w}  \sum_{n=1}^{N} (y_n - t_n) \nabla_\mathbf{w} a_n
        = \sum_{n=1}^{N} \big\{\nabla_\mathbf{w} y_n \nabla_\mathbf{w} a_n + 
        (y_n - t_n) \nabla_\mathbf{w} \nabla_\mathbf{w} a_n\big\}
    \end{align*}
